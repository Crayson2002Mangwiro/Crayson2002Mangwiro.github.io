...
- IPEC Status: ${$('canvas-ipec-status') ? $('canvas-ipec-status').textContent : '-'}`;
  ...
  async function handleSend() {
    ...
    try {
      const systemPrompt = `You are Innovation Challenge AI, a knowledgeable assistant for the Pension Fund Digital Twin dashboard. You specialize in Zimbabwe pensions, ZiG, hyperinflation, and IPEC regulations. Provide concise, professional answers.\n${getSimulationContext()}`;
      ...
      console.error('BOOST AI Error:', err);
